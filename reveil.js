exports.action = (data)=>{
   ...
   var  reponse=ClaraIA.reco
   var heurereveil=reponse.replace(new RegExp('[^0-9]', 'ig')," ").trim() 
   var reponse=reponse.replace(new RegExp('[^0-9]', 'ig'),"").trim()
                  
                 if(reponse==""){ ClaraIASpeech("précise un horaire au format heure minutes, merci"); return }
                ...
                ClaraIASpeech("réveil programmé à "+heurereveil.replace(" "," heure "))
...
var lieuxreveil=(frg,tempsfinal)=>{
      ...
      setTimeout(()=> {
          ...
          ClaraIASpeech("reveil demandé")
          console.log("Action reveil")
          ClaraIACall('Mathilde radio rire et chansons',frg)
